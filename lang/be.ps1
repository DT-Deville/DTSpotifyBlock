[PSCustomObject]@{
    Welcome         = "
╔════════════════════════════════════════╗
║ Сардэчна запрашаем у DTSpotifyBlock для Windows ║
╚════════════════════════════════════════╝"
    ...
    NewV2           = "Ваша версія Spotify ({0}) не была пратэставана. Стабільная версія для DTSpotifyBlock — {1}"
    ...
    Spicetify       = "Spicetify выяўлены, ён павінен быць усталяваны пасля DTSpotifyBlock, адкрыць рэкамендаваныя дзеянні ў FAQ? [Y/N]"
    NoRestore       = "DTSpotifyBlock ужо ўсталяваны, xpui.bak не знойдзены. Калі ласка, выдаліце кліент Spotify і запусціце Install.bat зноў"
