[PSCustomObject]@{
    Welcome         = "
╔═════════════════════════════╗
║ Vítejte v DTSpotifyBlock pro Windows ║
╚═════════════════════════════╝"
    ...
    Spicetify       = "Spicetify nalezeno, musí být nainstalováno po DTSpotifyBlock, otevřít doporučené akce ve FAQ? [Y/N]"
    NoRestore       = "DTSpotifyBlock byl již nainstalován, xpui.bak se nenašlo. `nProsím odinstalujte klienta Spotify a spusťte Install.bat znovu"
