[PSCustomObject]@{
    Welcome         = "
╔════════════════════════════════════╗
║ Καλώς ήρθατε στο DTSpotifyBlock για Windows ║
╚════════════════════════════════════╝"
    ...
    Spicetify       = "Spicetify detected, it must be installed after DTSpotifyBlock, open recommended actions in FAQ ? [Y/N]"
    NoRestore       = "Το DTSpotifyBlock έχει ήδη εγκατασταθεί, το xpui.bak δεν βρέθηκε. `nΠαρακαλώ απεγκαταστήστε το πρόγραμμα Spotify και εκτελέστε ξανά το Install.bat"
